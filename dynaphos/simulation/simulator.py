...
from dynaphos.simulation.cortex import get_cortical_magnification
from dynaphos.media.preprocessing import scale_image, to_n_dim
from dynaphos.simulation.utils import (to_tensor, get_data_kwargs, get_truncated_normal,
    ...
    def sampling_mask(self):
        ...
        if self._sampling_mask is None:
            ...
            if self._sampling_method == 'receptive_fields':
                ...
                # Center sampling retrieves pixels directly, but this mask is
                # still useful to callers that inspect the selected pixels.
